...
<div class="show_if_seller" style="<?php echo esc_attr( $role_style ); ?>">
        ...
        <p class="form-row form-group form-row-wide">
            <label for="reg_email"><?php esc_html_e( 'E-mail', 'dokan-theme' ); //Email address?> <span class="required">*</span></label>
    ...
    <!--<div class="split-row form-row-wide">-->
        <p class="form-row form-group">
            <label for="first-name"><?php esc_html_e( '姓名', 'dokan-lite' ); //First Name?> <span class="required">*</span></label>
        ...
        <!--<p class="form-row form-group">
            ...
            <input type="hidden" class="input-text form-control" name="lname" id="last-name" value="未輸入<?php //if ( ! empty( $postdata['lname'] ) ) echo esc_attr($postdata['lname']); ?>" required="required" />
        <!--</p>-->
    <!--</div>-->
    ...
    <p class="form-row form-group form-row-wide">
        <label for="seller-url" class="pull-left"><?php esc_html_e( 'Shop URL', 'dokan-lite' ); ?> (請自行填寫自己想要的英文或數字) <span class="required">*</span></label>
