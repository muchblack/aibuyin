                    ...
                    <div class="dokan-panel-body">
                        <?php
                            if ( $order->get_formatted_shipping_address() ) {
                                ...
                                esc_html_e( 'No shipping address set.', 'dokan' );
                            }
                        ?>
                    </div>
                </div>
                    ...
                    <div class="dokan-panel-body general-details">
                        <ul class="list-unstyled order-status">
                            ...
                            <li class="earning-from-order">
                                <span><?php esc_html_e( '此筆訂單收入:', 'dokan-lite' ); ?></span> <!-- Earning From Order -->
                        ...
                        <ul class="list-unstyled customer-details">
                            <li>
                                <span><?php esc_html_e( '日期:', 'dokan-lite' ); ?></span>
                                <?php echo esc_html( get_post_meta( dokan_get_prop( $order, 'id' ), 'date', true ) ); ?>
                            </li>
                            <li>
                                <?php $take_meal_time = esc_html( get_post_meta( dokan_get_prop( $order, 'id' ), 'eating_time', true ) ); ?>
                                <span><?php if($take_meal_time) echo "時間:"; ?></span>
                                <?php if($take_meal_time==1) echo "即時"; else echo $take_meal_time;?>
                            </li>
                            <li>
                                <?php $eating_time = esc_html( get_post_meta( dokan_get_prop( $order, 'id' ), 'eating_time', true ) ); ?>
                                <span><?php if($eating_time) echo "時間:"; ?></span>
                                <?php if($eating_time==1) echo "即時"; else echo $eating_time;?>
                            </li>
                            <li>
                                <?php
                                    if($take_meal_time == 1 || !$take_meal_time){
                                        echo "<span>訂餐類別: </span>外帶";
                                    }else if($eating_time == 1 || !$eating_time){
                                        echo "<span>訂餐類別: </span>內用";
                                    }
                                ?>
                            </li>
                            <li>
                                <?php $table_number = esc_html( get_post_meta( dokan_get_prop( $order, 'id' ), 'table_number', true ) ); ?>
                                <span><?php if($table_number) echo "桌號:"; ?></span>
                                <?php echo $table_number; ?>
                            </li>
                            <li>
                                <?php $people_number = esc_html( get_post_meta( dokan_get_prop( $order, 'id' ), 'people_number', true ) ); ?>
                                <span><?php if($people_number) echo "預約人數:"; ?></span>
                                <?php echo $people_number; ?>
                            </li>
                            <li>
