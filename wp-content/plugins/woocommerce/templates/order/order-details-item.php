...
<tr class="<?php echo esc_attr( apply_filters( 'woocommerce_order_item_class', 'woocommerce-table__line-item order_item', $item, $order ) ); ?>">
	...
	<td class="woocommerce-table__product-unit-price product-unit-price">
		<?php
			$get_quantity = $item->get_quantity();//購買產品數量
			$get_total = $item->get_total(); //產品購買總金額
			echo $get_total / $get_quantity; //產品單價
		?>
	</td>
