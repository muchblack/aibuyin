 ...
 * Class Migration
 *
 * @package WpSocialXs\XsMigration
 */
	...
	private function prepareOption_1_3_4_to_1_3_5() {
		...
		if(get_option($oldStructureOptions[$keySDC])) {
			...
			if(!empty($oldStructureOptions[$keySDC]['login_button_style'])) {
				...
				$styleArr = Settings::counter_styles();
				$hoverArr = \XsSocialSharePro\Inc\Admin_Settings::$counter_hover_effects;
				$foundKey = 'style-1';
		...
		if(get_option($oldStructureOptions[$keySDS])) {
			...
			if(!empty($oldStructureOptions[$keySDS]['login_button_style'])) {
				...
				$styleArr = Settings::share_styles();
				$hoverArr = \XsSocialSharePro\Inc\Admin_Settings::$share_hover_effects;
				$foundKey = 'style-1';
				$defHoverKey = 'none-none';
