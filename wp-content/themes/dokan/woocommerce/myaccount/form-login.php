...
<?php if ( get_option('woocommerce_enable_myaccount_registration') === 'yes' && get_option( 'users_can_register' ) == '1' ) : ?>
    ...
    <div class="col-md-6 reg-form">
        ...
        <form id="register" method="post" class="register">
            ...
            <p class="form-row form-group form-row-wide">
                <input type="hidden" class="input-text form-control" name="cell_phone" id="reg_cell_phone" value="<?php if ( ! empty( $_POST['cell_phone'] ) ) esc_attr( $_POST['cell_phone'] ); ?>" required="required" />
            </p>
