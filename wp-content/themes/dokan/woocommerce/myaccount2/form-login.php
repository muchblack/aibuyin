    ...
    <div class="col-md-6 reg-form">
        ...
        <form id="register" method="post" class="register">
            ...
            <p class="form-row form-group form-row-wide">
                ...
                <input type="cellphone" class="input-text form-control" name="cellphone" id="reg_cellphone" value="<?php if ( ! empty( $_POST['cellphone'] ) ) esc_attr($_POST['cellphone']); ?>" required="required" />
            </p>
