...
<head>
    ...
    <<?php echo esc_attr($title_tag); ?>><?php _e('Product Comparison', 'marketo') ?></<?php echo esc_attr($title_tag); ?>>
...
<h1>
    <?php echo marketo_kses($localized_table_text) ?>
    ...
    <?php else : ?>
            ...
            foreach ($products as $product_id => $product) :
                ...
                <td class="<?php echo esc_attr($product_class); ?>">
                    <a href="<?php echo add_query_arg('redirect', 'view', $this->remove_product_url($product_id)) ?>"
                       data-product_id="<?php echo esc_attr($product_id); ?>"><?php _e('Remove', 'marketo') ?>
        ...
        <?php if ($repeat_add_to_cart == 'yes' && isset($fields['add-to-cart'])) : ?>
            <tr class="add-to-cart repeated">
                <th><?php echo marketo_kses($fields['add-to-cart']) ?></th>
